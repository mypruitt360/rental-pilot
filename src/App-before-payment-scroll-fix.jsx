...
`;
  ...
  return <div className="shell">
    <aside>
      ...
      <div className="aside-foot">Portfolio workspace<br/><small>Version 1.9.1 · Payment Scroll Fix</small><br/><button className="text-button" style={{marginTop:10}} onClick={()=>supabase.auth.signOut()}>Sign out</button></div>
    </aside>
    <main>
      <header>
...
function PaymentModal({properties,residents,payments,month,initialResidentId,onClose,onSave}){
  ...
  return <div className="modal-backdrop" onMouseDown={onClose}><div className="modal payment-modal" onMouseDown={e=>e.stopPropagation()}>
    <div className="modal-head"><div><h2>Record Payment</h2><p>{monthLabel(month)} · rent collection</p></div><button className="icon-button" onClick={onClose}><X/></button></div>
