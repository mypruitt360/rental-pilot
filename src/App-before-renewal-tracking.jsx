...
export default function App(){
  ...
  return <div className="shell">
    <aside>
      ...
      <div className="aside-foot">Portfolio workspace<br/><small>Version 2.4 · Renewal Tracking</small><br/><button className="text-button" style={{marginTop:10}} onClick={()=>supabase.auth.signOut()}>Sign out</button></div>
    </aside>
    <main>
      <header>
...
function ResidentModal({mode='add',initial=null,properties,onClose,onSave}){
  const base={name:'',propertyId:properties[0]?.id||'',rent:'',email:'',phone:'',payerName:'',payerEmail:'',payerPhone:'',leaseStart:'',leaseEnd:'',renewalStatus:'Undecided',dueDay:1};
