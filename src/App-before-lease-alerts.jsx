...
export default function App(){
  ...
  return <div className="shell">
    <aside>
      ...
      <div className="aside-foot">Portfolio workspace<br/><small>Version 2.3 · Lease Alerts</small><br/><button className="text-button" style={{marginTop:10}} onClick={()=>supabase.auth.signOut()}>Sign out</button></div>
    </aside>
    <main>
      <header>
  ...
  return <>
    ...
    <section className="grid two">
      ...
      <div className="card">
        ...
        <div className="ledger">
          <div className="ledger-row ledger-head" style={{gridTemplateColumns:'1.3fr .9fr .8fr'}}>
            <span>Resident</span><span>Property</span><span>Timing</span>
          </div>
          {leaseAlerts.map(r=><div className="ledger-row" key={r.id} style={{gridTemplateColumns:'1.3fr .9fr .8fr'}}>
            <span style={{display:'flex',flexDirection:'column',gap:3}}>
              <strong>{r.name}</strong>
              <small>{r.leaseEnd}</small>
            </span>
