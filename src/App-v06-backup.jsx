...
import {
  ...
  CheckCircle2, Clock3, Target, TrendingUp, X, Save, ArrowRight, Sparkles, Receipt
} from 'lucide-react';
...
const nav = [
  ...
  ['Expenses', Receipt], ['Buy Box', Target], ['Reminders', BellRing], ['Maintenance', Wrench]
];
...
export default function App(){
  ...
  return <div className="shell">
    <aside>
      ...
      <div className="aside-foot">Portfolio workspace<br/><small>Version 0.5 · Financial Build</small></div>
    </aside>
    <main>
      <header>
